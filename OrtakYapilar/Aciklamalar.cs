...
2. yöntemde ebob hesaplamak için Öklid yöntemi kullanılmıştır. Bu yöntem, özyinemeli(recursive) yaklaşımla kodlanmıştır. Öklid yönteminde iki sayı büyükten küçüğe doğru sıralanır ve ardından sayılar biribirine bölünerek kalan hesaplanır. Eğer kalan sıfır ise küçük sayı ebob olarak kabul edilir. Eğer kalan sıfır değilse bölüm yerine küçük olan sayı, bölen yerine de kalan sayı alınarak işlemler tekrarlanır.
